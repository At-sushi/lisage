========================================================================
    Win32 アプリケーション: lisage プロジェクトの概要
========================================================================

この lisage アプリケーションは、AppWizard により作成されました。
...
lisage.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル lisage.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル lisage.rc 
    にインクルードされます。
